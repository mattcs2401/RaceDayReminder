 ...
 * @param raceDetailsDao
 * */
class RaceRepository(private val raceDetailsDao: RaceDetailsDAO) : IRaceRepo, KoinComponent {

//    // Database access.
//    private var raceDataBase: RaceDatabase by inject()

//    private var raceDetailsDao = raceDataBase.raceDetailsDao()
